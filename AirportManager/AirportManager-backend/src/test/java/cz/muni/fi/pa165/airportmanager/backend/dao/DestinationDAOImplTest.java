...
public class DestinationDAOImplTest extends AbstractTest{
    ...
    public void createDestinationTest(){
        ...
        try{
            ...
            if(!(e instanceof AirportDaoException)){
    ...
    public void updateDestinationTest(){
        ...
        try{
            ...
            if(!(ex instanceof AirportDaoException)){
    ...
    public void getAllIncomingFlightsTest(){
        ...
        try{
            ...
            fail("Get all incoming flights null argument - bad ecxeption " + ex);
        }
        ...
        try{
            ...
            fail("Get all incoming flights absent argument - bad ecxeption " + ex);
        }
    ...
    public void getAllOutcomingFlightsTest(){
        ...
        try{
            ...
            fail("Get all outcoming flights absent argument - bad ecxeption " + ex);
        }
